...
- 회원리스트 조회 코드(member_list)
    ...
    <table>
        ...
        <tr>
            <td>
                // 회원아이디 클릭시 해당 회원의 정보를 보여주는 member_info.jsp페이지로 이동하는 링크 생성, 정보를 보여줄 회원을 판단하기 위해 id값을 파라미터로 전송한다 
            ...
            <td>
                // 회원정보를 삭제하는 페이지인 member_delete.jsp 페이지로 이동하는 링크 설정,      삭제할 회원 판단위해 id값을 파라미터로 전송 
